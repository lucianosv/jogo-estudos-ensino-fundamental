...
const GameSetup = ({
  ...
  return <div className="min-h-screen flex items-center justify-center p-4">
        ...
        <CardHeader className="text-center bg-gradient-to-r from-purple-600 via-pink-600 to-orange-500 text-white rounded-t-lg">
            <CardTitle className="text-3xl font-bold tracking-wide">Viva a Aventura!</CardTitle>
            <p className="text-lg opacity-90 font-medium">Escolha a matéria, série e tema. </p>
        </CardHeader>
        <CardContent className="p-8">
            ...
            <div className="space-y-2">
             ...
             <div className="space-y-2">
                ...
                <Textarea id="themeDetails" value={themeDetails} onChange={e => setThemeDetails(e.target.value)} placeholder="Ex: Crie perguntas sobre as técnicas de respiração do Tanjiro, focando em problemas de multiplicação." className="text-base" />
            </div>
            <Button type="submit" className="w-full bg-gradient-to-r from-green-500 to-teal-500 hover:opacity-90 text-white font-bold py-4 px-10 text-xl rounded-full transform transition-all duration-200 hover:scale-105 shadow-lg">
